...
![44584d33257418329ed2484148b434d](https://raw.githubusercontent.com/jjzhou012/image/master/blogImg20200525192334.png)
...
自编码器可以表示为：$$ae=d \circ e$$，包含两部分，编码器（$$e: \mathbb{S} \rightarrow \mathbb{H}$$），解码器（$$d: \mathbb{H} \rightarrow \mathbb{S}$$），损失函数为均方误差$$L\left(\mathrm{X}_{\text {train }}\right)=\frac{1}{ \mid \mathrm{X}_{\text {train }} \mid } \sum_{x \in \mathbb{X}_{\text {train }}} \| x-a e(x) \|_{2}$$，重构误差为$$E(x)=\| x-a e(x)) \|_{p}$$
